...
#
#     avg_disp = (abs(avg_top_platen_disp[i]) + abs(avg_bottom_platen_disp[i]) for i in range(0, model.number_of_points_per_cell))
#     print(avg_disp)
...
#fname_iter = iter(f_names)
    # for i in range(0,len(f_names)):
    #     print(next(fname_iter))
...
# output = history_strain_func()
# for i in output:
#     print(i)

    # print(f"Start concurrelnt optimized n")
    # for i in range(1, 10):
    #     n = 2 ** i
