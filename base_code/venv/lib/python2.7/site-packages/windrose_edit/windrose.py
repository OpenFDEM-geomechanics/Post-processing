...
class WindroseAxes2(PolarAxes):
    ...
    def from_ax(ax=None, fig=None, rmax=None, *args, **kwargs):
        if ax is None:
            ...
            ax = WindroseAxes2(fig, rect, facecolor='w', rmax=rmax, *args, **kwargs)
            fig.add_axes(ax)
            return ax
        else:
            return ax
...
def wrcontour(direction, var, ax=None, rmax=None, **kwargs):
    ax = WindroseAxes2.from_ax(ax, rmax=rmax)
